...
if(isset($_POST['endereco']) || isset($_POST['ref'])){
    if(strlen($_POST['endereco']) == 0) {
        ...
        $mysqli-> query("INSERT INTO imoveis (referencia, endereco, area_terreno, area_construida, numero_quartos, numero_suites, numero_banheiros, bairro, preco, oportunidade, venda_loc, piscina, foto1, nome_foto1, foto2, nome_foto2, foto3, nome_foto3, foto4, nome_foto4, foto5, nome_foto5, foto6, nome_foto6, foto7, nome_foto7, foto8, nome_foto8, foto9, nome_foto9, foto10, nome_foto10) VALUES ('$ref', '$endereco', '$areaTer', '$areaCon', '$quartos', '$suites', '$banheiros', '$bairo', '$preco', '$oportunidade', '$venda_ou_loc', '$piscina', '$novonome1', '$path1', '$novonome2', '$path2', '$novonome3', '$path3', '$novonome4', '$path4', '$novonome5', '$path5', '$novonome6', '$path6', '$novonome7', '$path7', '$novonome8', '$path8', '$novonome9', '$path9', '$novonome10', '$path10')");
